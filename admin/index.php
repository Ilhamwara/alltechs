...
?>        
<form id="loginform" class="form-vertical" action="php/control/login.php" method="POST">
...
<form id="recoverform" action="php/control/login.php" method="POST" class="form-vertical">
