...
if ($page == 'pemesanan') {
	...
	<div class="container-fluid">
		<div class="widget-box">			
			<h3 style="padding: 10px;"><b>Pemesanan</b></h3>
			<div class="widget-content">
				<table class="table table-hover" style="text-align:center;">
					...
					if ($row == 0) {
						?>						
						<tr>
							<td colspan="8" style="background:#e74c3c; color: #fff; text-align: center;"><b>DATA KOSONG</b></td>
						</tr>
						<?php } ?>
						<!-- DATA KOSONG -->
	...
	//---------------------------------------FORM EDIT ROOM-------------------------------------------//
		elseif ($page == 'form-pemesanan') {
			...
			if (isset($_GET['key'])) {
				...
				$id = $_GET['key'];
				$query = mysql_query("SELECT pemesanan.id,member.nama,barang.foto,barang.nama_barang,pemesanan.status,pemesanan.bank,pemesanan.rekening,pemesanan.atasnama,pemesanan.tanggal,pemesanan.bukti,pemesanan.harga,pemesanan.qty FROM pemesanan INNER JOIN barang ON pemesanan.id_barang=barang.id INNER JOIN member ON pemesanan.id_user=member.id WHERE pemesanan.id='$id'");
				$rows = mysql_fetch_array($query);			
				?>
				<div class="container-fluid">
					<div class="widget-box">			
						<h3 style="padding: 10px;"><b>Form Pemesanan</b></h3>
						<br>	
						<div class="widget-content">						
							<table class="table table-striped text-center">
								...
								<tr>
									<td><b>Rekening</b></td>
									<td><b><?php echo $rows['bank']; ?></b> , <b><?php echo $rows['rekening']; ?></b> , a/n : <b><?php echo $rows['atasnama']; ?></b></td>
								</tr>
								<tr>
									<td><b>Harga</b></td>
